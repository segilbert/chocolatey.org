...
namespace NuGetGallery {
    ...
    public class Strings {
        ...
        /// <summary>
        ///   Looks up a localized string similar to The specified API key does not provide the authority to {0} packages. This package may already exist and be owned by a different user. It could also be hidden. If you try going directly to http://chocolatey.org/packages/&apos;packageName&apos;.
        /// </summary>
